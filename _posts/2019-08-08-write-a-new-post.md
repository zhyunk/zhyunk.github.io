...
```markdown
![img-description](https://chirpy-img.netlify.app/path/to/image)
_Image Caption_
```
{: .nolineno}
...
```markdown
![The flower](https://chirpy-img.netlify.app/path/to/flower.png)
```
{: .nolineno}
...
```markdown
![Image description](https://chirpy-img.netlify.app/path/to/image){: lqip="/path/to/lqip-file" }
```
{: .nolineno }
